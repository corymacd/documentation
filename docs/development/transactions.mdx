...
In the publishing to multiple partitions example, the request was coming from outside the system, and it was the app's responsibility to discover the true status of a timed out transaction. 
