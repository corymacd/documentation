...
Transactions turn Redpanda into a smart pipe. In addition to performing opaque data transfers, the system performs transformations (such as lookups or aggregations) on the data as well.
