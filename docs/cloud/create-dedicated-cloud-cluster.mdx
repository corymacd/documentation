...
After you select Dedicated dloud, create a Redpanda cluster:
...
12. In **IP Range**, type a range of IP addresses using CIDR notation to represent your network.
    For Class A, use 10.0.0.0. For Class B, use 172.16.0.0. For Class C, use 192.168.0.0. The default network IP range is 10.0.0.0/16.
13. Click **Create**.
