...
1. In **Connector name**, type a name for your connector. As a suggestion, use a name that indicates which S3 bucket the connector is sending data to.
2. In **Key converter class**, select a converter. Choices include:
    * org.apache.kafka.connect.storage.StringConverter
    * org.apache.kafka.connect.json.JsonConverter
    * org.apache.kafka.connect.converters.ByteArrayConverter
    * io.confluent.connect.avro.AvroConverter
    Note: (list unsupported connectors)
