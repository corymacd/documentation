...
To create an S3 sink connector, first choose the connector type, then configure connection properties, then review and apply the connector configuration.
...
After the connector is created, test the connection by writing to a topic and checking the contents of the S3 bucket in the AWS management console.
