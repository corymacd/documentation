...
5. In **Partitions**, type the number of partitions you want. The default is 1.
6. In **Replication Factor**, type the number of replicas for the topic. Three replicas are recommended.
