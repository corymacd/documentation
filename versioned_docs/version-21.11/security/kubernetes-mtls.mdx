...
[redpanda-examples../../example-config/kubernetes/mtls.yaml](https://github.com/redpanda-data/redpanda-examples/blob/main/docs/core/example-config/kubernetes/mtls.yaml)
